...
import { MessageSquare, Plus, Search, ArrowLeft, Home } from 'lucide-react';
...
const CandidatoMensagens = () => {
  ...
  const handleSelectConversation = (conv: Conversation) => {
    ...
    markConversationAsRead(conv.id);
    setShowMobileChat(true);
    navigate(`/candidato/mensagens/${conv.id}`, { replace: true });
  ...
  const handleBackToList = () => {
    ...
    navigate('/candidato/mensagens', { replace: true });
  };
  ...
  const filteredConversations = searchQuery 
    ...
    : conversations.filter(conv => {
        ...
        if (activeFilter === 'empresas') {
          return conv.participants.some(p => p.type === 'empresa');
        }
...
export default CandidatoMensagens;
